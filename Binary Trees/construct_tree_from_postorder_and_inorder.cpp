...
BinaryTreeNode<int>* getTreeFromPostorderAndInorder(int *postorder, int postLength, int *inorder, int inLength) {
    ...
    int lInorderSize=0;
    while(inorder[lInorderSize]!=postorder[postLength-1]){
        lInorderSize++;
    }

    root->left=getTreeFromPostorderAndInorder(postorder, lInorderSize, inorder, lInorderSize);

    int rInorderSize=inLength-lInorderSize-1;
   	root->right=getTreeFromPostorderAndInorder(postorder+lInorderSize, rInorderSize, inorder+lInorderSize+1, rInorderSize);
