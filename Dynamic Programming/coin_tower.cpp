...
//dp[i] denotes the state of beerus winning (1) or losing (0) when tower contains i coins
//dp[1] is alway because beerus can remove 1 and win the game , similarly dp[x] and dp[y] are 1 too
int dp[2000000];
